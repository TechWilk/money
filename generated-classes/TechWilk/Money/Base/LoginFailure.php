...
abstract class LoginFailure implements ActiveRecordInterface
{
     ...
     * TableMap class name.
     */
    const TABLE_MAP = '\\TechWilk\\Money\\Map\\LoginFailureTableMap';
    ...
    /**
     * Initializes internal state of TechWilk\Money\Base\LoginFailure object.
     *
     * @see applyDefaults()
     */
     ...
     *
     * @return $this|\TechWilk\Money\LoginFailure The current object (for fluent API support)
     */
 ...
 // hasOnlyDefaultValues()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Money\\LoginFailure'), 0, $e);
        }
    }
 ...
 // doSave()
     ...
     */
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = [])
    {
     ...
     *                      Defaults to TableMap::TYPE_PHPNAME.
     *
     * @return $this|\TechWilk\Money\LoginFailure
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Money\LoginFailure The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param object $copyObj  An object of \TechWilk\Money\LoginFailure (or compatible) type.
     ...
     * @throws PropelException
     *
     * @return \TechWilk\Money\LoginFailure Clone of current object.
     */
