...
/**
 * Base class that represents a row from the 'breakdown' table.
 *
 *
 *
 * @package    propel.generator.TechWilk.Money.Base
 */
abstract class Breakdown implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Money\\Map\\BreakdownTableMap';
    ...
    /**
     * Initializes internal state of TechWilk\Money\Base\Breakdown object.
     */
    ...
    /**
     * Compares this with another <code>Breakdown</code> instance.  If
     * <code>obj</code> is an instance of <code>Breakdown</code>, delegates to
     * <code>equals(Breakdown)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Breakdown The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BreakdownTableMap::COL_ID] = true;
        }
    ...
    public function setTransactionId($v)
    {
        ...
        if ($this->transaction_id !== $v) {
            ...
            $this->modifiedColumns[BreakdownTableMap::COL_TRANSACTION_ID] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[BreakdownTableMap::COL_DESCRIPTION] = true;
        }
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[BreakdownTableMap::COL_VALUE] = true;
        }
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[BreakdownTableMap::COL_CATEGORY_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BreakdownTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BreakdownTableMap::translateFieldName('TransactionId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->transaction_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BreakdownTableMap::translateFieldName('Description', TableMap::TYPE_PHPNAME, $indexType)];
            $this->description = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BreakdownTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBreakdownQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Breakdown::setDeleted()
     * @see Breakdown::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBreakdownQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BreakdownTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BreakdownTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_TRANSACTION_ID)) {
            $modifiedColumns[':p' . $index++]  = 'transaction_id';
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = 'description';
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_VALUE)) {
    ...
    {
        $pos = BreakdownTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Breakdown'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Breakdown'][$this->hashCode()] = true;
        $keys = BreakdownTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Money\Breakdown
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Money\Breakdown The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BreakdownTableMap::COL_ID)) {
            $criteria->add(BreakdownTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_TRANSACTION_ID)) {
            $criteria->add(BreakdownTableMap::COL_TRANSACTION_ID, $this->transaction_id);
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_DESCRIPTION)) {
            $criteria->add(BreakdownTableMap::COL_DESCRIPTION, $this->description);
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_VALUE)) {
            $criteria->add(BreakdownTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(BreakdownTableMap::COL_CATEGORY_ID)) {
    ...
    {
        $criteria = ChildBreakdownQuery::create();
        $criteria->add(BreakdownTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Money\Breakdown (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Money\Breakdown Clone of current object.
     * @throws PropelException
     */
    ...
    public function getTransaction(ConnectionInterface $con = null)
    {
        if ($this->aTransaction === null && ($this->transaction_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTransaction->addBreakdowns($this);
             */
        }
    ...
    public function getCategory(ConnectionInterface $con = null)
    {
        if ($this->aCategory === null && ($this->category_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aCategory->addBreakdowns($this);
             */
        }
    ...
    {
        if (null !== $this->aTransaction) {
            $this->aTransaction->removeBreakdown($this);
        }
        if (null !== $this->aCategory) {
            $this->aCategory->removeBreakdown($this);
        }
        $this->id = null;
