...
class BreakdownTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.BreakdownTableMap';
     ...
     */
    const OM_CLASS = '\\Breakdown';

    /**
     * A class that can be returned by this tableMap.
     */
    const CLASS_DEFAULT = 'Breakdown';
 ...
 // initialize()
  ...
  0 => [
    ...
    1 => ':id',
        ...
        $this->addRelation('Category', '\\Category', RelationMap::MANY_TO_ONE, [
  0 => [
    0 => ':category_id',
    1 => ':id',
  ],
    ...
    public static function buildTableMap()
    {
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
         ...
         if ($values instanceof Criteria) {
             // rename for clarity
            $criteria = $values;
         } elseif ($values instanceof \Breakdown) { // it's a model object
