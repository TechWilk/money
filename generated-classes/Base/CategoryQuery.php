...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    public function filterByBreakdown($breakdown, $comparison = null)
    {
        if ($breakdown instanceof \Breakdown) {
            ...
            throw new PropelException('filterByBreakdown() only accepts arguments of type \Breakdown or Collection');
        }
    }
    ...
    public function useBreakdownQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'Breakdown', '\BreakdownQuery');
    }
