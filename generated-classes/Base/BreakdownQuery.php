 ...
 * @method     \TransactionQuery|\CategoryQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
...
abstract class BreakdownQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Base\BreakdownQuery object.
     *
     * @param string $dbName     The database name
     * @param string $modelName  The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'money', $modelName = '\\Breakdown', $modelAlias = null)
    {
