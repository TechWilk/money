...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Money\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of TechWilk\Money\Base\Category object.
     */
     ...
     * @return $this|\TechWilk\Money\Category The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\TechWilk\\Money\\Category'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->breakdownsScheduledForDeletion !== null) {
                if (!$this->breakdownsScheduledForDeletion->isEmpty()) {
                    \TechWilk\Money\BreakdownQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Money\Category
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Money\Category The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Money\Category (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Money\Category Clone of current object.
     * @throws PropelException
     */
