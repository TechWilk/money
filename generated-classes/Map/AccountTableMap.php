...
class AccountTableMap extends TableMap
{
 ...
 // initialize()
    ...
    {
        $this->addRelation('Transaction', '\\Transaction', RelationMap::ONE_TO_MANY, [
  0 => [
    0 => ':account_id',
    1 => ':id',
  ],
], null, null, 'Transactions', false);
        $this->addRelation('Category', '\\Category', RelationMap::ONE_TO_MANY, [
  0 => [
    0 => ':account_id',
    1 => ':id',
  ],
  ...
  0 => [
    ...
    1 => ':id',
        ...
        $this->addRelation('User', '\\User', RelationMap::MANY_TO_MANY, [], null, null, 'Users');
    }
