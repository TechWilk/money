 ...
 * @method     \TechWilk\Money\TransactionHashtagQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
...
abstract class HashtagQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \TechWilk\Money\Base\HashtagQuery object.
     *
     * @param string $dbName     The database name
     * @param string $modelName  The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'money', $modelName = '\\TechWilk\\Money\\Hashtag', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof ChildHashtagQuery) {
            return $criteria;
        }
        $query = new ChildHashtagQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildHashtag A model object, or null if the key is not found
     */
    ...
    public function filterByTag($tag = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(HashtagTableMap::COL_TAG, $tag, $comparison);
    }
    ...
    public function doDeleteAll(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            HashtagTableMap::clearRelatedInstancePool();
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $criteria->setDbName(HashtagTableMap::DATABASE_NAME);
        ...
        return $con->transaction(function () use ($con, $criteria) {
            ...
            HashtagTableMap::removeInstanceFromPool($criteria);
