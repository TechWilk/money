 ...
 * @method     \TechWilk\Money\TransactionQuery|\TechWilk\Money\HashtagQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
...
abstract class TransactionHashtagQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \TechWilk\Money\Base\TransactionHashtagQuery object.
     *
     * @param string $dbName     The database name
     * @param string $modelName  The phpName of a model, e.g. 'Book'
     * @param string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'money', $modelName = '\\TechWilk\\Money\\TransactionHashtag', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \TechWilk\Money\Hashtag object.
     *
     * @param \TechWilk\Money\Hashtag|ObjectCollection $hashtag    The related object(s) to use as filter
     * @param string                                   $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($hashtag instanceof \TechWilk\Money\Hashtag) {
            return $this
            ...
            throw new PropelException('filterByHashtag() only accepts arguments of type \TechWilk\Money\Hashtag or Collection');
        }
    }
     ...
     * @param string $joinType      Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \TechWilk\Money\HashtagQuery A secondary query class using the current class as primary query
     */
    public function useHashtagQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinHashtag($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Hashtag', '\TechWilk\Money\HashtagQuery');
    }
