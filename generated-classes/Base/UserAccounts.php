...
abstract class UserAccounts implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\UserAccountsTableMap';
    ...
    /**
     * Initializes internal state of Base\UserAccounts object.
     */
     ...
     * @return $this|\UserAccounts The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\UserAccounts'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO user_accounts (%s) VALUES (%s)',
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getUserId() &&
            null !== $this->getAccountId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation user_accounts_fk_29554a to table user
        ...
        //relation user_accounts_fk_474870 to table account
    ...
    {
        return (null === $this->getUserId()) && (null === $this->getAccountId());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \UserAccounts (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \UserAccounts Clone of current object.
     * @throws PropelException
     */
