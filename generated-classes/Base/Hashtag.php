...
abstract class Hashtag implements ActiveRecordInterface
{
    ...
    public function setTransactionId($v)
    {
        ...
        if ($this->transaction_id !== $v) {
            ...
            $this->modifiedColumns[HashtagTableMap::COL_TRANSACTION_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : HashtagTableMap::translateFieldName('Tag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : HashtagTableMap::translateFieldName('TransactionId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(HashtagTableMap::COL_TRANSACTION_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HashtagTableMap::COL_TRANSACTION_ID)) {
            $criteria->add(HashtagTableMap::COL_TRANSACTION_ID, $this->transaction_id);
        }
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getTag() &&
            null !== $this->getTransactionId();

        $validPrimaryKeyFKs = 1;
        $primaryKeyFKs = [];

        //relation hashtag_fk_98bea7 to table transaction
    ...
    {
        return (null === $this->getTag()) && (null === $this->getTransactionId());
    }
    ...
    public function getTransaction(ConnectionInterface $con = null)
    {
        if ($this->aTransaction === null && ($this->transaction_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aTransaction->addHashtags($this);
             */
        }
    ...
    {
        if (null !== $this->aTransaction) {
            $this->aTransaction->removeHashtag($this);
        }
        $this->tag = null;
