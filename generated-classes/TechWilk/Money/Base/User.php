...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\TechWilk\\Money\\Map\\UserTableMap';
     ...
     *
     * @var        \TechWilk\Money\EmailAddress
     */
    protected $email;
    ...
    /**
     * Initializes internal state of TechWilk\Money\Base\User object.
     * @see applyDefaults()
     */
     ...
     *
     * @return \TechWilk\Money\EmailAddress
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $this->email = (null !== $col) ? new \TechWilk\Money\EmailAddress($col) : null;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\TechWilk\Money\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\TechWilk\Money\User The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \TechWilk\Money\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \TechWilk\Money\User Clone of current object.
     * @throws PropelException
     */
    ...
    public function setUserAccounts(Collection $userAccounts, ConnectionInterface $con = null)
    {
        ...
        foreach ($userAccountsToDelete as $userAccountRemoved) {
            $userAccountRemoved->setUser(null);
        }
     ...
     * @return ObjectCollection|ChildUserAccount[] List of ChildUserAccount objects
     */
    public function getUserAccountsJoinAccount(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildUserAccountQuery::create(null, $criteria);
        $query->joinWith('Account', $joinBehavior);
    ...
    public function initAccounts()
    {
        ...
        $this->collAccounts->setModel('\TechWilk\Money\Account');
    }
